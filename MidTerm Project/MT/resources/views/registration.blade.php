                    ...
                    <form action="{{ route('registration.store') }}" method="POST">
                        ...
                        <div class="mb-3 d-flex justify-content-between">
                            ...
                            <div style="width:45%;">
                                ...
                                <input type="email" id="email" name="email"
                                    class="form-control @error('email') is-invalid @enderror" value="{{old(key: 'email')}}">
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="address" name="address"
                                class="form-control @error('address') is-invalid @enderror" value="{{old(key: 'address')}}">
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
